...
void ElectrosenseContext::print() {
  ...
  std::cout << "Bias-Tee: " << getBiasTee() << std::endl;
  ...
  std::cout << "Segment Overlap: " << getSoverlap() << std::endl;
  std::cout << "Compression Level: " << getComprLevel() << std::endl;
  std::cout << "TcpHosts: " << getTcpHosts() << std::endl;
  std::cout << "Authentication Interface: " << getIface() << std::endl;
#if defined(RPI_GPU)
...
const std::string &ElectrosenseContext::getIface() const { return mIface; }

void ElectrosenseContext::setIface(const std::string &iface) {
  mIface = iface;
}

const int &ElectrosenseContext::getBiasTee() const { return mBiasTee; }
